...
@section('content')
      <section class="section overflow-hidden">
        ...
        <div class="row row-gap-0 bg-white" id="kt_login">
                    ...
                    <div class="d-flex flex-column-fluid flex-column flex-center p-4 mt-5">
                        ...
                        <div class="login-form login-signin">
                            <div class="text-center mb-10 mb-lg-20">
                                <img src="{{ asset('new assets/images/CL-LOGO.png') }}" alt="logo" width="100" class="shadow rounded-circle mb-3 mt-2">
                            ...
                            <form method="POST" action="{{ route('login.auth',['barangay_id'=>$barangay->id]) }}" class="form">
                                @csrf
                            <!--begin::Form-->
            ...
            <div class="col-lg-9 col-md-8 px-0 "  style="background-image: url({{ asset('img/cl-townplaza.jpg') }}); background-size: cover; background-repeat: no-repeat;
            max-width:100%;">
                <div class="d-flex align-items-end justify-content-start vh-100">
                    <h3 class="text-center px-5 mb-5">
                    <span class="bg-glass-radius-10 py-1 px-2">{{ $barangay->name }}</span>    
                    </h3>
                </div>
            </div>
            <!--begin::Aside-->
