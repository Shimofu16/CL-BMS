...
<head>
    ...
    <link rel="preload" href="{{asset('home/logo/calauan.webp')}}" as="image">
...
<body>
    ...
    @include('frontend.municipality.calauan.layouts.header')
    ...
    @include('frontend.municipality.calauan.layouts.footer')
