                        ...
                        <div class="body">
                            <div class="officials" style="width: 2.75in; border-left: 2px solid black;">
                                <div class="official-wrapper">
                                    ...
                                    @elseif($b_official->brgy_official_position == 'Secretary')
                                    <p>
                                    ...
                                    @elseif($b_official->position == 'SK Chairperson')
                                    <p>
                                        <strong>{{ $b_official->full_name }}</strong><br>
                                        {{ $b_official->position }}
                                    </p>
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="text-part" style="margin-top:100px;">
                                        ...
                                        <P id="issue-for">
                                            ...
                                            magbakod sa kanilang nasasakupan sa {{ $fencing->details['location']}}.
                                        </P>
