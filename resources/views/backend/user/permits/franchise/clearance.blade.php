...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Barangay Franchise Clearance</h3>
    </div>
                        ...
                        <div class="body">
                            <div class="officials" style="width: 2.75in; border-left: 2px solid black;">
                                <div class="official-wrapper">
                                    ...
                                    @elseif($b_official->position == 'Barangay Treasurer')
                                    <p>
                                        <strong>{{ $b_official->full_name }}</strong><br>
                                        {{ $b_official->position }}
                                    </p>

                                    @elseif($b_official->position == 'Barangay Clerk')
                                    <p>
                                        <strong>{{ $b_official->full_name }}</strong><br>
                                        {{ $b_official->position }}
                                    </p>
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="text-part">
                                        ...
                                        <div style="margin-left: 20px; margin-top:20px;">
                                            ...
                                            <strong>
                                                <p>Name:
                                            </strong>{{ $franchise->owner->full_name }}
                                            </p>
                                            <strong>
                                                <p>Address:
                                            </strong>{{ $franchise->owner->address }}</p>
                                            <strong>
                                                <p>Birthday:
                                            </strong>{{$franchise->owner->birthday}}</p>
                                            <strong>
                                                <p>Birthplace:
                                            </strong>{{$franchise->owner->birthplace}}</p>
                                            <strong>
                                                <p>Motor No.:
                                            </strong>{{ $franchise->details['motor']}}</p>
                                            <strong>
                                                <p>Chasis No.:
                                            </strong>{{ $franchise->details['chassis']}}</p>
                                            <strong>
                                                <p>Plate No.:
                                            </strong>{{ $franchise->details['plate']}}</p>
                                        ...
                                        <p id="witness">
                                            ...
                                            <strong>
                                                Barangay {{ Auth::user()->official->barangay->name }}, Calauan, Laguna.
                                            </strong>
                                        </p>
