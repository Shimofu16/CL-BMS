...
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <div>
            <h3 class="page__heading">Barangay Meralco Clearance</h3>
        </div>
        <div>
                        ...
                        <div class="body">
                            ...
                            <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                <div class="content-wrapper">
                                    ...
                                    {{-- <p style="margin-top:30px;"> <strong>Control No.</strong> {{
                                        $meralco->meralaco_clearance_number }}</p> --}}

                                    <div class="text-part" style="margin-top:100px;">
                                        <p id="to-whom">TO WHOM IT MAY CONCERN:</p>
                                        <p id="content">
                                            This is to cerify that <strong> {{
                                                $meralco->details['building_type'] }}</strong> owned by
                                            <strong>{{ $meralco->details['applicant'] }}</strong> of Brgy {{
                                            Auth::user()->official->barangay->name }},
                                            Calauan, Laguna will be constructed at along <strong>{{
                                                $meralco->details['address'] }}</strong>. This further certifies
                                    ...
                                    <div style="margin-top: 60px;">
                                        <strong>Date Issued: </strong>{{ \Carbon\Carbon::today()->format('l jS \\of F
                                        Y') }}
                                    </div>
                                </div>
                            </div>
