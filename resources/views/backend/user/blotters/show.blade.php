        ...
        <div class="row">
            <div class="col-12">
                <div class="card" id="border-blue">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="button" class="btn btn-outline-primary my-2" data-bs-toggle="modal"
                                    data-bs-target="#action"> <i class="far fa-edit"></i>
                                    Add Action
                                </button>
                                @else
                    ...
                    <div class="card-body">
                        <strong>Complained Person/s:</strong>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag3_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag3"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                            @endif
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <p><strong>Date of Patawag:</strong>
                                        {{ $blotter->lbp3_date ? \Carbon\Carbon::parse($blotter->lbp3_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                <div class="col-12 d-flex justify-content-center">
                                    @if ($blotter->status == 'Unsettled')
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->lbp3_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                        ...
                        <div class="card" id="border-blue">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            @if ($blotter->lbp3 == null)
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag2_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag2"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                            ...
                                            @else
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#" disabled> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag2" disabled>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <p><strong>Date of Patawag:</strong>
                                        {{ $blotter->lbp2_date ? \Carbon\Carbon::parse($blotter->lbp2_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                @if ($blotter->lbp3 == null)
                                <div class="col-12 d-flex justify-content-center">
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->lbp2_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                                        class="btn btn-outline-success btn-sm px-3">Generate
                                        Letter</a>
                                </div>
                                @endif
                        ...
                        <div class="card" id="border-blue">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            @if ($blotter->lbp2 == null)
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag1_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag1"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                            ...
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#luponpatawag1" disabled>
                                                <i class="far fa-edit"></i>
                                                Action
                                            </button>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <p><strong>Date of Patawag:</strong>
                                        {{ $blotter->lbp1_date ? \Carbon\Carbon::parse($blotter->lbp1_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                @if ($blotter->lbp2 == null)
                                <div class="col-12 d-flex justify-content-center">
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->lbp1_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                                        class="btn btn-outline-success btn-sm px-3">Generate
                                        Letter</a>
                                </div>
                                @endif
                        ...
                        <div class="card" id="border-blue">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            @if ($blotter->lbp1 == null)
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag3_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag3"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                            ...
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag3" disabled> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <p><strong>Date of Patawag:</strong>
                                        {{ $blotter->bcp3_date ? \Carbon\Carbon::parse($blotter->bcp3_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                @if ($blotter->lbp1 == null)
                                <div class="col-12 d-flex justify-content-center">
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->bcp3_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                                        class="btn btn-outline-success btn-sm px-3">Generate
                                        Letter</a>
                                </div>
                                @endif
                        ...
                        <div class="card" id="border-blue">
                            <div class="card-header">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag2_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag2"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag2" disabled> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <p><strong>Date of Patawag:</strong>
                                        {{ $blotter->bcp2_date ? \Carbon\Carbon::parse($blotter->bcp2_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                @if ($blotter->bcp3 == null)
                                <div class="col-12 d-flex justify-content-center">
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->bcp2_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                                        class="btn btn-outline-success btn-sm px-3">Generate
                                        Letter</a>
                                </div>
                                @endif
                        ...
                        <div class="card" id="border-blue">
                            <div class="card-header">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag1_manage"> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag1"> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                                        ...
                                        @else
                                        <div>
                                            <button type="button" class="btn btn-outline-primary my-2" disabled> <i
                                                    class="far fa-edit"></i>
                                                Manage
                                            </button>
                                            <button type="button" class="btn btn-outline-primary my-2"
                                                data-bs-toggle="modal" data-bs-target="#patawag1" disabled> <i
                                                    class="far fa-edit"></i>
                                                Action
                                            </button>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <p><strong> Date of Patawag:</strong>
                                        {{ $blotter->bcp1_date ? \Carbon\Carbon::parse($blotter->bcp1_date)->format('F
                                        d, Y h:i A') : null }}
                                    </p>
                                ...
                                @if ($blotter->bcp2 == null)
                                <div class="col-12 d-flex justify-content-center">
                                    <a href="{{ route('user.barangay.blotters.patawag', [\Carbon\Carbon::parse($blotter->bcp1_date)->format('F d, Y h:i A'), $blotter->id]) }}"
                                        class="btn btn-outline-success btn-sm px-3">Generate
                                        Letter</a>
                                </div>
                                @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form method="POST" action="{{ route('user.barangay.blotters.update', $blotter->id) }}"
...
<div class="modal fade" id="luponpatawag3_manage" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label></label>
                    <form method="POST" action="{{ route('user.barangay.blotters.manage', $blotter->id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
...
<!-- Lupon Patawag 2 Manage MODAL-->
<div class="modal fade" id="luponpatawag2_manage" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="luponpatawag1_manage" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
