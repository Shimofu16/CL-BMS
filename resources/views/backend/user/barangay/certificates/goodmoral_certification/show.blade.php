                        ...
                        <div class="wrapper">
                            <div class="header">
                                ...
                                <div class="title-wrapper">
                                    <h1 style="border-left: 2px solid black; border-right: 2px solid black;">Barangay Good
                                        Moral Certificate</h1>
                                </div>
                            </div>
                                ...
                                <div class="content" style="width: 5.55in; border-right: 2px solid rgb(5, 4, 4);">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="text-part">
                                            ...
                                            <p id="content">
                                                This is to certify that <strong>{{ name }}</strong> of legal age and bonafide resident
                                                of <strong>{{ address }}</strong> has not been charged of any misconduct in violation of Barangay
                                                rules and policies. Neither had I received any information that he/she has
                                                no pending case in court. He/she is observed to be of <strong>Good Moral
                                                    Character</strong>.


                                            <P id="issue-for">
                                                This certification is being issued upon the request of
                                                <strong>{{ name }}</strong> for
