                                ...
                                <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="text-part">
                                            ...
                                            <p id="content">
                                                Ito ay pagpapatunay na sila <strong>{{ name }} at
                                                    {{ $partner }}</strong> nasa hustong taong gulang, residente ng
                                                <strong>{{ address }}</strong> ay nagsasama bilang mag asawa.
                                                Pagpapatunay pa din na sila ay nagsasama ng humigit kumulang
                                                <strong>{{ $long }}</strong> ng nagsama bilang mag asawa
