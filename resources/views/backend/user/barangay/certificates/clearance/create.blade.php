...
<section class="section">
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <h2 class="section-title">{{ $resident->gender == 'Male' ? 'Mr.' : 'Ms.' }} {{ $resident->full_name }}
                </h2>
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-12 mt-5">
                                        ...
                                        <p class="ml-5">
                                            ...
                                            <strong>Incident:
                                            </strong>{{ \Carbon\Carbon::parse($blotter->date_of_incident)->format('F d,
                                            Y') }}
                                        <p>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-6">
                        <div class="card" id="border-blue" style="margin-top: 35px;">
                            ...
                            <form
                                action="{{ route('user.barangay.certificate.store', ['certificate_type' => 'barangay_clearance','resident_id' => $resident->id]) }}"
