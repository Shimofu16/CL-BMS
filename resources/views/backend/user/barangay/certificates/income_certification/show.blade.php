                        ...
                        <div class="wrapper">
                            <div class="header">
                                ...
                                <div class="title-wrapper">
                                    <h1 style="border-left: 2px solid black; border-right: 2px solid black;">Barangay Income
                                        Certificate</h1>
                                </div>
                            </div>
                                ...
                                <div class="content" style="width: 5.55in; border-right: 2px solid black;">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="text-part">
                                            ...
                                            <p id="content">
                                                Ito ay pagpapatunay na si <strong>{{ name }}</strong>,
                                                <strong>{{ age }}</strong>
